...
<head runat="server">
    ...
    <title>F5 EDU | ADD EMPLOYEE</title>
            ...
            <div class="container-fluid">
                <div class="row" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="form-group-inner formInnerGroupRowBtn">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <asp:Button runat="server" ID="AddEmp" class="btn btn-default btn-lg" Text="Add Employee"
                                    OnClick="AddEmp_Click" type="button" Style="outline: none; background-color: #5A6268; color: white" />
                            </div>
                        </div>
                    </div>
                </div>
