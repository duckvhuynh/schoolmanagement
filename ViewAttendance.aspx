...
<head runat="server">
    ...
    <title>F5 EDU | VIEW ATTENDANCE</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">View Attendance</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="200px" Width="100%" AutoGenerateColumns="False">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="OPTION" HeaderStyle-CssClass="">
                                                        <ItemTemplate>
                                                            <asp:RadioButton runat="server" Height="40px"     Enabled="false" Width="83px" GroupName="g1"  Font-Names="Lucida Sans" ID="RadioButton3" Text="Present" />
                                                            <asp:RadioButton ID="RadioButton1" Height="40px"  Enabled="false" runat="server" GroupName="g1"  Font-Names="Lucida Sans" Text="Absent" Width="84px" />
                                                            <asp:RadioButton ID="RadioButton2" runat="server" Enabled="false" Font-Names="Lucida Sans" GroupName="g1" Height="40px" Text="  Late" Width="63px" />
                                                            <asp:RadioButton ID="RadioButton4" runat="server" Enabled="false" Font-Names="Lucida Sans" GroupName="g1" Height="40px" Text="Leave" Width="63px" />
                                                        </ItemTemplate>
                                                        <HeaderStyle Font-Size="Large" HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="REMARKS" HeaderStyle-CssClass="">
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" CssClass="form-control basic-ele-mg-t-10" Enabled="false" Font-Names="Lucida Sans" Height="25px" Width="310px" />
                                                        </ItemTemplate>
                                                        <HeaderStyle Font-Size="Large" />
                                                        <ItemStyle Width="30%" />
                                                    </asp:TemplateField>
