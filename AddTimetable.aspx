<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTimetable.aspx.cs" Inherits="AddTimetable" %>
...
<head runat="server">
    ...
    <title>F5 EDU | ADD TIMETABLE</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">Add Timetable</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                <div class="row" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="form-group-inner formInnerGroupRowBtn">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <asp:Button runat="server" ID="AddTime" class="btn btn-default btn-lg" Text="Add Timetable"
                                    OnClick="AddTime_Click" ValidationGroup="Submit" type="submit" Style="outline: none; background-color: #5A6268; color: white" />
                            </div>
                        </div>
                    </div>
                </div>
