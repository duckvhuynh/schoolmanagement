...
<head runat="server">
    ...
    <title>F5 EDU | VIEW RESULT</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">View Result</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <asp:TextBox runat="server" ID="SID" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Exam Type</label>
                                        <asp:TextBox runat="server" ReadOnly="true" ID="EType" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
