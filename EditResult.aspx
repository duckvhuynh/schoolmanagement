<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditResult.aspx.cs" Inherits="EditResult" %>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">Edit Result</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="row" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="margin-top: 5px;">
                        ...
                        <div class="form-group-inner formInnerGroupRowBtn">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <asp:Button runat="server" ID="EditRes" class="btn btn-default btn-lg" Text="Edit Result"
                                        OnClick="EditRes_Click" ValidationGroup="Submit" type="submit" Style="outline: none; background-color: #5A6268; color: white" />
                                </div>
                            </div>
                        </div>
                    </div>
