                ...
                <div class="row" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="margin-top: 5px;">
                        ...
                        <div class="form-group-inner formInnerGroupRowBtn">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <asp:Button runat="server" ID="AddE" class="btn btn-default btn-lg" Text="Add Exam"
                                        OnClick="AddE_Click" ValidationGroup="Submit" type="submit" Style="outline: none; background-color: #5A6268; color: white" />
                                </div>
                            </div>
                        </div>
                    </div>
