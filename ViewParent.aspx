<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewParent.aspx.cs" Inherits="ViewParent" %>
...
<head runat="server">
    ...
    <title>F5 EDU | VIEW PARENT</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">View Parent</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <asp:TextBox runat="server" ID="PFname" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Parent Firstname"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Parent Lastname</label>
                                        <asp:TextBox runat="server" ID="PLname" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Parent Lastname"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Parent Email</label>
                                        <asp:TextBox runat="server" ID="PEmail" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Email"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <asp:TextBox runat="server" ID="PPass" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Parent Password"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Parent Telephone</label>
                                        <asp:TextBox runat="server" ReadOnly="true" ID="PTel" CssClass="form-control basic-ele-mg-t-10" placeholder="Telephone"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Parent Mobile Phone</label>
                                        <asp:TextBox runat="server" ID="PMoblie" CssClass="form-control basic-ele-mg-t-10" ReadOnly="true" placeholder="Parent Mobile Phone"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Parent CNIC</label>
                                        <asp:TextBox runat="server" ID="PCNIC" CssClass="form-control basic-ele-mg-t-10" ReadOnly="true" placeholder="Parent CNIC"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <asp:TextBox runat="server" ID="PADD" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Parent Address"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Parent Relationship</label>
                                        <asp:TextBox runat="server" ID="PREL" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Parent Relationship"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
