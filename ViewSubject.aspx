<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSubject.aspx.cs" Inherits="ViewSubject" %>
...
<head runat="server">
    ...
    <title>F5 EDU | VIEW SUBJECTS</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">View Subject</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group-inner">
                                <div class="row formInnerGroupRow">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <asp:TextBox runat="server" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Subject Description" Style="border-radius: 5px;"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row formInnerGroup mg-t-30">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-left: 230px;">
                                        ...
                                        <asp:TextBox runat="server" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Subject Name" Style="border-radius: 5px;" />
                                    </div>
                                </div>
                                <div class="row formInnerGroup mg-t-30">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-left: 230px;">
                                        <label class="login2">Class Name</label>
                                        <asp:TextBox runat="server" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10" placeholder="Class Name" Style="border-radius: 5px;" />
                                    </div>
                                </div>
