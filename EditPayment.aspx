<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPayment.aspx.cs" Inherits="EditPayment" %>
...
<head runat="server">
    ...
    <title>F5 EDU | EDIT PAYMENT</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">Edit Payment</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                <div class="row" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="form-group-inner formInnerGroupRowBtn">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <asp:Button runat="server" ID="AddPay" class="btn btn-default btn-lg" Text="Edit Payment"
