    ...
    <form id="form2" runat="server">
        <nav class="Lnavbar">
            <ul class="Lnavbar-nav">
                ...
                <li class="Lnav-item">
                    <a href="Employee.aspx" class="Lnav-link Lnav-link-current">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: flex; justify-content: space-between; align-items: center; top: 0px; left: 0px;">
                        <h2>&nbsp;Employees</h2>
                        <div>
                            <a href="EditEmployee.aspx" style="color: white">
                                <button type="button" class="btn btn-primary" style="padding: 6px 20px; outline: none; background-color: rgb(90 98 103);">Edit Employee</button></a>
                            <a href="AddEmployee.aspx" style="color: white">
                                <button type="button" class="btn btn-primary" style="padding: 6px 20px; outline: none; background-color: rgb(90 98 103);">Add Employee</button></a>
                        </div>
                    </div>
                        ...
                        <div class="gvWidthHight">
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="200px" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="E_MobileNo" HeaderText="MOBILE NO">
                                    ...
                                    <asp:BoundField DataField="E_RoleID" HeaderText="ROLE">
                                        <HeaderStyle Font-Size="Large" />
                                        <ItemStyle Width="17%" Font-Size="Medium" />
                                    </asp:BoundField>
                                    <asp:ButtonField ButtonType="Button" HeaderText="OPTION" CommandName="viewemp" ControlStyle-BackColor="#007BFF" ControlStyle-BorderStyle="None" ControlStyle-Height="30px" ControlStyle-Width="100px" ControlStyle-Font-Names="Lucida Sans" Text="View">
