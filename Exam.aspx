                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">Exams</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: flex; justify-content: space-between; align-items: center; top: 0px; left: 0px;">
                        <h2>&nbsp;Exams</h2>
                        <a href="AddExam.aspx" style="color: white">
                            <button type="button" class="btn btn-primary" style="padding: 6px 20px; outline: none; background-color: rgb(90 98 103);">Add Exam</button></a>
                    </div>
                        ...
                        <div class="gvWidthHight">
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="200px" Width="100%" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button Text="View" runat="server" BackColor="#007BFF" PostBackUrl="~/ViewExam.aspx" BorderStyle="None" Height="30px" Width="100px" CssClass="mar"
                                                Font-Names="Lucida Sans" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
