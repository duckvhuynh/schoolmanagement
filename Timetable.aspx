                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">Timetables</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: flex; justify-content: space-between; align-items: center; top: 0px; left: 0px;">
                        <h2>&nbsp;Time Tables</h2>
                        <a href="AddTimetable.aspx" style="color: white">
                            <button type="button" class="btn btn-primary" style="padding: 6px 20px; outline: none; background-color: rgb(90 98 103);">Add Timetable</button></a>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                        <div class="gvWidthHight">
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="200px" Width="100%" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    <asp:BoundField DataField="TT_ID" HeaderText="ID">
                                        <HeaderStyle Height="50px" CssClass="pad" Font-Size="Large" />
                                        <ItemStyle CssClass="pad" Width="30%" Font-Size="Medium" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="TT_SectionID" HeaderText="SectionID">
                                        <HeaderStyle Font-Size="Large" />
                                        <ItemStyle Width="30%" Font-Size="Medium" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="TT_DAY" HeaderText="DAY">
                                        <HeaderStyle Font-Size="Large" />
                                        <ItemStyle Width="30%" Font-Size="Medium" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="TT_StartTime" HeaderStyle-CssClass="StartTime">
                                        <ItemTemplate>
                                            <asp:Button Text="Edit" runat="server" PostBackUrl="~/EditTimetable.aspx" BackColor="#17A2B8" BorderStyle="None" Height="30px" Width="100px" CssClass="mar"
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button Text="View" runat="server" BackColor="#007BFF" PostBackUrl="~/ViewTimetable.aspx" BorderStyle="None" Height="30px" Width="100px" CssClass="mar"
                                                Font-Names="Lucida Sans" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
