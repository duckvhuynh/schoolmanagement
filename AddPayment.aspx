...
<head runat="server">
    ...
    <title>F5 EDU | ADD PAYMENT</title>
    ...
    <form id="form2" runat="server">
        <nav class="Lnavbar">
            <ul class="Lnavbar-nav">
                ...
                <li class="Lnav-item">
                    <a href="Payment.aspx" class="Lnav-link Lnav-link-current">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><a href="Payment.aspx"><b>Payments</b></a> <span class="bread-slash">/</span>
                                                </li>
                                                <li><span class="bread-blod">Add Payment</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                <div class="row" style="display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="margin-top: 5px;">
                        <div class="sparkline10-list mg-b-20" style="box-shadow: 2px 2px 28px #8888889e; border-radius: 5px; height: 45 vh">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Payment ID</label>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <asp:TextBox runat="server" ID="SID" placeholder="Enter Student ID" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ValidationGroup="Submit" Style="font-size: smaller; top: 5px; position: relative; color: red"
                                            ErrorMessage="Invalid SID*" ControlToValidate="SID"
                                            ValidationExpression="^[0-9]{11}"></asp:RegularExpressionValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Issue Date</label>
                                        <asp:TextBox runat="server" ID="IssueDate" placeholder="Select Issue Date" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ErrorMessage="Issue Date Required*"
                                            ControlToValidate="IssueDate"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Due Date</label>
                                        <asp:TextBox runat="server" ID="DueDate" placeholder="Select Due Date" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ...
                                            ControlToValidate="DueDate"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Previous Charges</label>
                                        <asp:TextBox runat="server" ReadOnly="true" ID="PCharges" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Discount Charges</label>
                                        <asp:TextBox runat="server" ID="DCharges" CssClass="form-control basic-ele-mg-t-10" placeholder="Enter Discount Charges"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ErrorMessage="Discount Charges Required*"
                                            ControlToValidate="DCharges"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="Submit" Style="font-size: smaller; top: 5px; position: relative; color: red"
                                            ErrorMessage="Invalid Charges*" ControlToValidate="DCharges"
                                            ValidationExpression="^-?[0-9][0-9,\.]+$"></asp:RegularExpressionValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Discount Reason</label>
                                        <asp:TextBox runat="server" ID="DReason" CssClass="form-control basic-ele-mg-t-10" placeholder="Enter Discount Reason"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ErrorMessage="Discount Reason Required*"
                                            ControlToValidate="DCharges"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ValidationGroup="Submit" Style="font-size: smaller; top: 5px; position: relative; color: red"
                                            ErrorMessage="Invalid Input*" ControlToValidate="DReason"
                                            ValidationExpression="^^[A-Za-z ]+$"></asp:RegularExpressionValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Fees Status</label>
                                        <asp:TextBox runat="server" ID="Fstatus" CssClass="form-control basic-ele-mg-t-10" placeholder="Enter Fees Status"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ErrorMessage="Fee Status Required*"
                                            ControlToValidate="Fstatus"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ValidationGroup="Submit" Style="font-size: smaller; top: 5px; position: relative; color: red"
                                            ErrorMessage="Invalid Input*" ControlToValidate="Fstatus"
                                            ValidationExpression="^^[A-Za-z ]+$"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Fees Amount</label>
                                        <asp:TextBox runat="server" ID="FAmount" CssClass="form-control basic-ele-mg-t-10" placeholder="Enter Fees Amount"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ErrorMessage="Fees Amount Required*"
                                            ControlToValidate="FAmount"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ValidationGroup="Submit" Style="font-size: smaller; top: 5px; position: relative; color: red"
                                            ErrorMessage="Invalid Charges*" ControlToValidate="FAmount"
                                            ValidationExpression="^-?[0-9][0-9,\.]+$"></asp:RegularExpressionValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Additional Amount</label>
                                        <asp:TextBox runat="server" ID="AAmount" CssClass="form-control basic-ele-mg-t-10" placeholder="Enter Additional Amount"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ErrorMessage="Additional Amount Required*"
                                            ControlToValidate="AAmount"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ValidationGroup="Submit" Style="font-size: smaller; top: 5px; position: relative; color: red"
                                            ErrorMessage="Invalid Amount*" ControlToValidate="AAmount"
                                            ValidationExpression="^-?[0-9][0-9,\.]+$"></asp:RegularExpressionValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Paid Date</label>
                                        <asp:TextBox runat="server" ID="PDate" CssClass="form-control basic-ele-mg-t-10" placeholder="Enter Paid Date"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ValidationGroup="Submit" Style="font-size: smaller; left: 0px; top: 5px; color: red; position: relative;"
                                            ErrorMessage="Paid Date Required*"
                                            ControlToValidate="PDate"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 mg-t-30">
                                        <asp:Button runat="server" ID="AddVouc" class="btn btn-info" Text="Generate Voucher"
                                            OnClick="AddVouc_Click" Style="outline: none;" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group-inner formInnerGroupRowBtn">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <asp:Button runat="server" ID="AddPay" class="btn btn-default btn-lg" Text="Add Payment"
                                    OnClick="AddPay_Click" ValidationGroup="Submit" type="submit" Style="outline: none; background-color: #5A6268; color: white" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $("#PDate").datepicker(
{
    ...
    dateFormat: 'yy/mm/dd'
        ...
        document.querySelector('#AddVouc').addEventListener('click', function (event) {
