<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditSubject.aspx.cs" Inherits="EditSubject" %>
...
<head runat="server">
    ...
    <title>F5 EDU | EDIT SUBJECTS</title>
        ...
        <main>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="display: flex;">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">Edit Subject</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="form-group-inner formInnerGroupRowBtn">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <asp:Button runat="server" ID="EditSubj" class="btn btn-default btn-lg" Text="Edit Subject"
                                OnClick="EditSubj_Click" type="button" Style="outline: none; background-color: #5A6268; color: white" />
                        </div>
                    </div>
                </div>
            </div>
