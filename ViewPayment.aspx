<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPayment.aspx.cs" Inherits="ViewPayment" %>
...
<head runat="server">
    ...
    <title>F5 EDU | VIEW PAYMENT</title>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <asp:TextBox runat="server" ID="DCharges" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label class="login2">Section Name</label>
                                        <asp:TextBox runat="server" ID="DReason" ReadOnly="true" CssClass="form-control basic-ele-mg-t-10"></asp:TextBox>
                                    </div>
